...
test_net = network(
        ...
        tau_exc=sim_params['tau_exc'] * 2, tau_inh=sim_params['tau_inh'] * 2,
...
steps_sim = int(sim_params['sim_time'] / sim_params['dt'] * 2 / 2)

print(sim_params['tau_exc'] * 2, sim_params['tau_inh'] * 2, steps_sim)
